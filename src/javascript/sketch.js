...
const setup = function() {
  ...
  const point = new Uniform(ctx, 'point', Uniform.TYPE_V2, [window.innerWidth*.5,window.innerHeight*.5]);
  ...
  //   }
    ...
    if(playing) {
      ...
      renderer.setupProgram(programMain, [drawBuffer], [], [time, mouse, point]);
      renderer.render(4);
